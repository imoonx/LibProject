...
public class VideoPlayerStandard extends VideoPlayer {
    ...
    public void setUp(String url, int screen, Object... objects) {
        ...
        if (currentScreen == SCREEN_WINDOW_FULLSCREEN) {
            ...
            if (null != getContext())
                changeStartButtonSize((int) getContext().getResources().getDimensionPixelSize(R.dimen.video_space_60));
            else
                changeStartButtonSize(100);
            ...
            tinyBackImageView.setVisibility(View.INVISIBLE);
            if (null != getContext())
                changeStartButtonSize((int) getContext().getResources().getDimensionPixelSize(R.dimen.video_space_45));
            else
                changeStartButtonSize(90);
        } else if (currentScreen == SCREEN_WINDOW_TINY) {
            tinyBackImageView.setVisibility(View.VISIBLE);
            setAllControlsVisible(View.INVISIBLE, View.INVISIBLE, View.INVISIBLE, View.INVISIBLE, View.INVISIBLE,
            ...
            switch (event.getAction()) {
                ...
                case MotionEvent.ACTION_UP:
                    ...
                    if (!mChangePosition && !mChangeVolume) {
                        onEvent(VideoUserActionStandard.ON_CLICK_BLANK);
                        onClickUiToggle();
                    }
                    break;
            }
    ...
    public void onClick(View v) {
        ...
        if (i == R.id.thumb) {
            ...
            if (currentState == CURRENT_STATE_NORMAL) {
                if (!url.startsWith("file") && !url.startsWith("/") && !VideoUtils.isWifiConnected(getContext())
    ...
    public void startVideo() {
        prepareMediaPlayer();
        onEvent(VideoUserActionStandard.ON_CLICK_START_THUMB);
    }
    ...
    public void changeUiToPauseShow() {
        switch (currentScreen) {
            case SCREEN_LAYOUT_NORMAL:
            case SCREEN_LAYOUT_LIST:
                setAllControlsVisible(View.VISIBLE, View.VISIBLE, View.VISIBLE, View.INVISIBLE, View.INVISIBLE,
                        View.INVISIBLE, View.INVISIBLE);
                updateStartImage();
                break;
            case SCREEN_WINDOW_FULLSCREEN:
    ...
    public void changeUiToPlayingBufferingClear() {
        switch (currentScreen) {
            case SCREEN_LAYOUT_NORMAL:
            case SCREEN_LAYOUT_LIST:
                setAllControlsVisible(View.INVISIBLE, View.INVISIBLE, View.INVISIBLE, View.VISIBLE, View.INVISIBLE,
...
//        bottomProgressBar.setVisibility(bottomPro);
    ...
    public void showProgressDialog(float deltaX, String seekTime, int seekTimePosition, String totalTime, int totalTimeDuration) {
        super.showProgressDialog(deltaX, seekTime, seekTimePosition, totalTime,
                totalTimeDuration);
        if (mProgressDialog == null) {
            View localView = LayoutInflater.from(getContext()).inflate(R.layout.video_dialog_progress, null);
            mDialogProgressBar = ((ProgressBar) localView.findViewById(R.id.duration_progressbar));
            mDialogSeekTime = ((TextView) localView.findViewById(R.id.tv_current));
            mDialogTotalTime = ((TextView) localView.findViewById(R.id.tv_duration));
            mDialogIcon = ((ImageView) localView.findViewById(R.id.duration_image_tip));
            mProgressDialog = new Dialog(getContext(), R.style.style_dialog_progress);
    ...
    public void showVolumeDialog(float deltaY, int volumePercent) {
        ...
        if (mVolumeDialog == null) {
            View localView = LayoutInflater.from(getContext()).inflate(R.layout.video_dialog_volume, null);
            ...
            mVolumeDialog = new Dialog(getContext(), R.style.style_dialog_progress);
        ...
        if (volumePercent <= 0) {
            mDialogVolumeImageView.setBackgroundResource(R.drawable.video_close_volume);
        } else {
            mDialogVolumeImageView.setBackgroundResource(R.drawable.video_add_volume);
        }
    ...
    public void showBrightnessDialog(int brightnessPercent) {
        ...
        if (mBrightnessDialog == null) {
            View localView = LayoutInflater.from(getContext()).inflate(R.layout.video_dialog_brightness, null);
            ...
            mBrightnessDialog = new Dialog(getContext(), R.style.style_dialog_progress);
...
//                            }
    ...
    public void onAutoCompletion() {
        ...
        setAllControlsVisible(View.INVISIBLE, View.INVISIBLE, View.VISIBLE, View.INVISIBLE, View.VISIBLE,
                View.INVISIBLE, View.INVISIBLE);
        cancelDismissControlViewTimer();
    }
