 ...
 * </p>
 */
public class VideoMediaManager implements TextureView.SurfaceTextureListener, MediaPlayer.OnPreparedListener, MediaPlayer.OnCompletionListener,
    ...
    private static VideoMediaManager mVideoMediaManager;
    public static VideoResizeTextureView textureView;
    ...
    public static VideoMediaManager instance() {
        if (mVideoMediaManager == null) {
            mVideoMediaManager = new VideoMediaManager();
        }
        return mVideoMediaManager;
    }

    public VideoMediaManager() {
        mMediaHandlerThread = new HandlerThread(this.getClass().getSimpleName());
            ...
            switch (msg.what) {
                case HANDLER_PREPARE:
                    try {
                        ...
                        XLog.e(VideoMediaManager.class, e);
                    }
                    break;
    ...
    public void onSurfaceTextureAvailable(SurfaceTexture surfaceTexture, int i, int i1) {
        XLog.i(this.getClass(), "onSurfaceTextureAvailable [" + this.hashCode() + "] ");
    ...
    public void onSurfaceTextureSizeChanged(SurfaceTexture surfaceTexture, int i, int i1) {
        ...
        XLog.i(this.getClass(), "onSurfaceTextureSizeChanged [" + this.hashCode() + "] ");
    }
