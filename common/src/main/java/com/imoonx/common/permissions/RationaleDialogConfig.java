...
/**
 * 配置信息提示对话框 {@link RationaleDialogFragment} or
...
public class RationaleDialogConfig {
    ...
    public RationaleDialogConfig(@StringRes int positiveButton, @StringRes int negativeButton, @NonNull String rationaleMsg,
