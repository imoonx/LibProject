...
/**
 * {@link AppCompatDialogFragment} to display rationale for permission requests
 * when the request comes from a Fragment or Activity that can host a Fragment.
 */
...
public class RationaleDialogFragmentCompat extends AppCompatDialogFragment {
    ...
    static RationaleDialogFragmentCompat newInstance(@StringRes int positiveButton, @StringRes int negativeButton,
