...
public class ViewHolder {
    ...
    public void setImageForNet(int viewId, String imgUrl) {
        setImageForNet(viewId, imgUrl, R.drawable.image_placeholder);
    }

    public void setImageForNet(ImageView iv, String imgUrl) {
        setImageForNet(iv, imgUrl, R.drawable.image_placeholder);
    }
    ...
    public void setImageForNet(ImageView iv, String imgUrl, int emptyRes, int errorRes) {
        RequestManager loader = mCaller.getImgLoader();
        GlideImageLoader.loadImage(loader, iv, imgUrl, emptyRes, errorRes);
    }
