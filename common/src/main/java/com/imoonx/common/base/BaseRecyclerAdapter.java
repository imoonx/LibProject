            ...
            case VIEW_TYPE_FOOTER:
                ...
                switch (mState) {
                    case STATE_INVALID_NETWORK:
                        fvh.tv_footer.setText(Res.getString(R.string.footer_type_net_error));
                        fvh.pb_footer.setVisibility(View.GONE);
                        break;
                    case STATE_LOAD_MORE:
                    case STATE_LOADING:
                        fvh.tv_footer.setText(Res.getString(R.string.footer_type_loading));
                        fvh.pb_footer.setVisibility(View.VISIBLE);
                        break;
                    case STATE_NO_MORE:
                        fvh.tv_footer.setText(Res.getString(R.string.footer_type_not_more));
                        fvh.pb_footer.setVisibility(View.GONE);
                        break;
                    ...
                    case STATE_LOAD_ERROR:
                        fvh.tv_footer.setText(Res.getString(R.string.footer_type_error));
                        fvh.pb_footer.setVisibility(View.GONE);
                        break;
                    case STATE_HIDE:
