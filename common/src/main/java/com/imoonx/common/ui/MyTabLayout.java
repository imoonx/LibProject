...
import com.imoonx.common.base.PagerInfo;
...
public class MyTabLayout extends FrameLayout implements ValueAnimator.AnimatorUpdateListener {
    ...
    public MyTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mValueAnimator = ValueAnimator.ofObject(new PointEvaluator(), mLastP,
                mCurrentP);
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        mIndicatorMarginLeft = ta.getDimension(R.styleable.MyTabLayout_zq_indicator_margin_left, Res.dip2px(0));
        mIndicatorMarginTop = ta.getDimension(R.styleable.MyTabLayout_zq_indicator_margin_top, 0);
        mIndicatorMarginRight = ta.getDimension(R.styleable.MyTabLayout_zq_indicator_margin_right, Res.dip2px(0));
        ...
        mDividerWidth = ta.getDimension(R.styleable.MyTabLayout_zq_divider_width, Res.dip2px(1));
        mDividerPadding = ta.getDimension(R.styleable.MyTabLayout_zq_divider_padding, 0);
        mTextsize = ta.getDimension(R.styleable.MyTabLayout_zq_textsize, Res.dip2px(13f));
        ...
        mTabWidth = ta.getDimension(R.styleable.MyTabLayout_zq_tab_width, Res.dip2px(-1));
        mTabPadding = ta.getDimension(R.styleable.MyTabLayout_zq_tab_padding, mTabSpaceEqual || mTabWidth > 0 ? Res.dip2px(0) : Res.dip2px(10));
        ...
        mBarStrokeWidth = ta.getDimension(R.styleable.MyTabLayout_zq_bar_stroke_width, Res.dip2px(1));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        mIndicatorDrawable.setBounds(
                paddingLeft + (int) mIndicatorMarginLeft + mIndicatorRect.left, (int) mIndicatorMarginTop,
                (int) (paddingLeft + mIndicatorRect.right - mIndicatorMarginRight), (int) (mIndicatorMarginTop + mIndicatorHeight));
    ...
    private void updateTabStyles() {
        for (int i = 0; i < mTabCount; i++) {
            ...
            // tv_tab_title.setPadding((int) mTabPadding, 0, (int) mTabPadding,
            // 0);
            if (mTextAllCaps) {
    ...
    private void calcOffset() {
        ...
        // Log.d("AAA", "mCurrentP--->" + mCurrentP.left + "&" +
        // mCurrentP.right);
    ...
    // 设置 导航数据
    public void setTabData(PagerInfo[] pagerInfo) {
        String[] titles = new String[pagerInfo.length];
        for (int i = 0; i < pagerInfo.length; i++) {
            titles[i] = pagerInfo[i].getTitle();
        }
    ...
    private void addTab(final int position, View tabView) {
        ...
        LinearLayout.LayoutParams lp_tab = mTabSpaceEqual ? new LinearLayout.LayoutParams(
                0, LayoutParams.MATCH_PARENT, 1.0f) : new LinearLayout.LayoutParams(LayoutParams.WRAP_CONTENT,
    ...
    public void setTabPadding(float tabPadding) {
        this.mTabPadding = Res.dip2px(tabPadding);
        updateTabStyles();
    }
    ...
    public void setTabWidth(float tabWidth) {
        this.mTabWidth = Res.dip2px(tabWidth);
        updateTabStyles();
    }
    ...
    public void setIndicatorHeight(float indicatorHeight) {
        this.mIndicatorHeight = Res.dip2px(indicatorHeight);
        invalidate();
    }

    public void setIndicatorCornerRadius(float indicatorCornerRadius) {
        this.mIndicatorCornerRadius = Res.dip2px(indicatorCornerRadius);
        invalidate();
    }
    ...
    public void setIndicatorMargin(float indicatorMarginLeft, float indicatorMarginTop, float indicatorMarginRight, float indicatorMarginBottom) {
        this.mIndicatorMarginLeft = Res.dip2px(indicatorMarginLeft);
        this.mIndicatorMarginTop = Res.dip2px(indicatorMarginTop);
        this.mIndicatorMarginRight = Res.dip2px(indicatorMarginRight);
        this.mIndicatorMarginBottom = Res.dip2px(indicatorMarginBottom);
        invalidate();
    }
    ...
    public void setDividerWidth(float dividerWidth) {
        this.mDividerWidth = Res.dip2px(dividerWidth);
        invalidate();
    }

    public void setDividerPadding(float dividerPadding) {
        this.mDividerPadding = Res.dip2px(dividerPadding);
        invalidate();
    }

    public void setTextsize(float textsize) {
        this.mTextsize = Res.dip2px(textsize);
        updateTabStyles();
    }
