 ...
 */
package com.imoonx.file.recycle;
...
import com.imoonx.file.recycle.animation.AlphaInAnimation;
import com.imoonx.file.recycle.animation.BaseAnimation;
import com.imoonx.file.recycle.animation.ScaleInAnimation;
import com.imoonx.file.recycle.animation.SlideInBottomAnimation;
import com.imoonx.file.recycle.animation.SlideInLeftAnimation;
import com.imoonx.file.recycle.animation.SlideInRightAnimation;
import com.imoonx.file.recycle.entity.IExpandable;
import com.imoonx.file.recycle.loadmore.LoadMoreView;
import com.imoonx.file.recycle.loadmore.SimpleLoadMoreView;
import com.imoonx.file.recycle.util.MultiTypeDelegate;
...
public abstract class BaseQuickAdapter<T, K extends BaseViewHolder> extends RecyclerView.Adapter<K> {
     ...
     * @deprecated This method is because it can lead to crash: always call this
     * method while RecyclerView is computing a layout or scrolling.
     * Please use
     * {@link #setOnLoadMoreListener(RequestLoadMoreListener, RecyclerView)}
     */
    @Deprecated
    ...
    /**
     * check if full page after {@link #setNewData(List)}, if full, it will
     * enable load more again.
     * <p>
     * 不是配置项！！
     * <p>
     * 这个方法是用来检查是否满一屏的，所以只推荐在 {@link #setNewData(List)} 之后使用 原理很简单，先关闭 load
     * more，检查完了再决定是否开启
     * <p>
     * 不是配置项！！
     *
    ...
    public void disableLoadMoreIfNotFullPage(RecyclerView recyclerView) {
        ...
        if (manager instanceof LinearLayoutManager) {
            ...
            recyclerView.postDelayed(new Runnable() {
                ...
                public void run() {
                    if ((linearLayoutManager
                            .findLastCompletelyVisibleItemPosition() + 1) != getItemCount()) {
            ...
            recyclerView.postDelayed(new Runnable() {
                @Override
                public void run() {
                    final int[] positions = new int[staggeredGridLayoutManager
                            .getSpanCount()];
    ...
    public void addData(@IntRange(from = 0) int position,
        ...
        notifyItemRangeInserted(position + getHeaderLayoutCount(),
                newData.size());
    ...
    public void addData(@NonNull Collection<? extends T> newData) {
        ...
        notifyItemRangeInserted(mData.size() - newData.size()
                + getHeaderLayoutCount(), newData.size());
        compatibilityDataSizeChanged(newData.size());
    }

    /**
     * use data to replace all item in mData. this method is different
     * {@link #setNewData(List)}, it doesn't change the mData reference
     *
    ...
    /**
     * if setHeadView will be return 1 if not will be return 0. notice:
     * Deprecated! Use {@link ViewGroup#getChildCount()} of
     * {@link #getHeaderLayout()} to replace.
     *
     * @return
     */
    @Deprecated
    ...
    /**
     * if mFooterLayout will be return 1 or not will be return 0. notice:
     * Deprecated! Use {@link ViewGroup#getChildCount()} of
     * {@link #getFooterLayout()} to replace.
     *
     * @return
     */
    @Deprecated
    ...
    public int getItemCount() {
        ...
        if (getEmptyViewCount() == 1) {
            ...
            count = getHeaderLayoutCount() + mData.size()
                    + getFooterLayoutCount() + getLoadMoreViewCount();
        }
        return count;
    }
    ...
    /**
     * When set to true, the item will layout using all span area. That means,
     * if orientation is vertical, the view will have full width; if orientation
     * is horizontal, the view will have full height. if the hold view use
     * StaggeredGridLayoutManager they should using all span area
     *
                    ...
                    .setSpanSizeLookup(new GridLayoutManager.SpanSizeLookup() {
                        ...
                        public int getSpanSize(int position) {
                            ...
                            if (mSpanSizeLookup == null) {
                                return isFixedViewType(type) ? gridManager
                                        .getSpanCount() : 1;
                            } else {
                                return (isFixedViewType(type)) ? gridManager
                                        .getSpanCount() : mSpanSizeLookup
    ...
    /**
     * if asFlow is true, footer/header will arrange like normal item view. only
     * works when use {@link GridLayoutManager},and it will ignore span size.
     */
    ...
    /**
     * @param spanSizeLookup instance to be used to query number of spans occupied by each
     *                       item
     */
    ...
    private void bindViewClickListener(final BaseViewHolder baseViewHolder) {
        ...
        if (getOnItemClickListener() != null) {
            view.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    getOnItemClickListener().onItemClick(
        ...
        if (getOnItemLongClickListener() != null) {
            view.setOnLongClickListener(new View.OnLongClickListener() {
                ...
                public boolean onLongClick(View v) {
                    return getOnItemLongClickListener().onItemLongClick(
                            BaseQuickAdapter.this,
                            v,
                            baseViewHolder.getLayoutPosition()
                                    - getHeaderLayoutCount());
    ...
    /**
     * if you want to use subclass of BaseViewHolder in the adapter, you must
     * override the method to create new ViewHolder.
     *
     * @param view view
    ...
    /**
     * Add header view to mHeaderLayout and set header view position in
     * mHeaderLayout. When index = -1 or index >= child count in mHeaderLayout,
     * the effect of this method is the same as that of
     * {@link #addHeaderView(View)}.
     *
     * @param header
     * @param index  the position in mHeaderLayout of this header. When index = -1
     *               or index >= child count in mHeaderLayout, the effect of this
     *               method is the same as that of {@link #addHeaderView(View)}.
     */
    ...
    public int addHeaderView(View header, int index, int orientation) {
        if (mHeaderLayout == null) {
            ...
            if (orientation == LinearLayout.VERTICAL) {
                ...
                mHeaderLayout.setLayoutParams(new LayoutParams(MATCH_PARENT,
                        WRAP_CONTENT));
            } else {
                mHeaderLayout.setOrientation(LinearLayout.HORIZONTAL);
                mHeaderLayout.setLayoutParams(new LayoutParams(WRAP_CONTENT,
                        MATCH_PARENT));
            }
        }
    ...
    /**
     * Add footer view to mFooterLayout and set footer view position in
     * mFooterLayout. When index = -1 or index >= child count in mFooterLayout,
     * the effect of this method is the same as that of
     * {@link #addFooterView(View)}.
     *
     * @param footer
     * @param index  the position in mFooterLayout of this footer. When index = -1
     *               or index >= child count in mFooterLayout, the effect of this
     *               method is the same as that of {@link #addFooterView(View)}.
     */
    public int addFooterView(View footer, int index, int orientation) {
        if (mFooterLayout == null) {
            ...
            if (orientation == LinearLayout.VERTICAL) {
                ...
                mFooterLayout.setLayoutParams(new LayoutParams(MATCH_PARENT,
                        WRAP_CONTENT));
            } else {
                mFooterLayout.setOrientation(LinearLayout.HORIZONTAL);
                mFooterLayout.setLayoutParams(new LayoutParams(WRAP_CONTENT,
                        MATCH_PARENT));
            }
        }
    ...
    /**
     * remove header view from mHeaderLayout. When the child count of
     * mHeaderLayout is 0, mHeaderLayout will be set to null.
     *
     * @param header
     */
    ...
    /**
     * remove footer view from mFooterLayout, When the child count of
     * mFooterLayout is 0, mFooterLayout will be set to null.
     *
     * @param footer
     */
     ...
     *
     * @param isHeadAndEmpty false will not show headView if the data is empty true will
     *                       show emptyView and headView
     */
    ...
    /**
     * set emptyView show if adapter is empty and want to show headview and
     * footview Call before
    ...
    /**
     * When the current adapter is empty, the BaseQuickAdapter can display a
     * special view called the empty view. The empty view is used to provide
     * feedback to the user that no data is available in this AdapterView.
     *
     ...
     * @param parent      Optional view to be the parent of the generated hierarchy or
     *                    else simply an object that provides a set of LayoutParams
     ...
     *
     * @param animationType One of {@link #ALPHAIN}, {@link #SCALEIN},
     *                      {@link #SLIDEIN_BOTTOM}, {@link #SLIDEIN_LEFT},
     *                      {@link #SLIDEIN_RIGHT}.
     */
     ...
     *
     * @param firstOnly true just show anim when first loading false show anim when
    ...
    /**
     * get the specific view by position,e.g. getViewByPosition(2,
     * R.id.textView)
     * <p>
     * bind recyclerView {@link #bindToRecyclerView(RecyclerView)} before use!
     *
    ...
    @Nullable
    public View getViewByPosition(RecyclerView recyclerView, int position,
                                  @IdRes int viewId) {
        if (recyclerView == null) {
            return null;
        }
        BaseViewHolder viewHolder = (BaseViewHolder) recyclerView
    ...
    private int recursiveExpand(int position, @NonNull List<?> list) {
        ...
        for (int i = list.size() - 1; i >= 0; i--, pos--) {
            if (list.get(i) instanceof IExpandable) {
                IExpandable<T> item = (IExpandable<T>) list.get(i);
                if (item.isExpanded() && hasSubItems(item)) {
                    List<T> subList = item.getSubItems();
     ...
     * @param shouldNotify notify the RecyclerView to rebind items,
     *                     <strong>false</strong> if you want to do it yourself.
    ...
    public int expand(@IntRange(from = 0) int position, boolean animate,
        ...
        IExpandable<T> expandable = (IExpandable<T>) getExpandableItem(position);
        if (expandable == null) {
            return 0;
        }
    ...
    public int expandAll(int position, boolean animate, boolean notify) {
        ...
        if (notify) {
            if (animate) {
                notifyItemRangeInserted(position + getHeaderLayoutCount() + 1,
                        count);
            } else {
                notifyDataSetChanged();
            }
     ...
     *
     * @param position position of the item, which includes the header layout count.
     * @param init     whether you are initializing the recyclerView or not. if
     *                 <strong>true</strong>, it won't notify recyclerView to redraw
     *                 UI.
    ...
    private int recursiveCollapse(@IntRange(from = 0) int position) {
        ...
        int subItemCount = 0;
        if (expandable.isExpanded()) {
            List<T> subItems = (List<T>) expandable.getSubItems();
     ...
     *
     * @param position the position of the item, which includes the header layout
     *                 count.
    ...
    private int getItemPosition(T item) {
        return item != null && mData != null && !mData.isEmpty() ? mData
                .indexOf(item) : -1;
    }

    private boolean hasSubItems(IExpandable<T> item) {
        if (item == null) {
            return false;
        }
     ...
     *
     * @return return the closest parent item position of the IExpandable. if
     * the IExpandable item's level is 0, return itself position. if the
     * item's level is negative which mean do not implement this, return
     * a negative if the item is not exist in the data list, return a
     * negative.
     */
    public int getParentPosition(@NonNull T item) {
        ...
        // if the item is IExpandable, return a closest IExpandable item
        // position whose level smaller than this.
        // if it is not, return the closest IExpandable item position whose
    ...
    /**
     * Interface definition for a callback to be invoked when an itemchild in
     * this view has been clicked
     */
    ...
    /**
     * Interface definition for a callback to be invoked when an childView in
     * this view has been clicked and held.
     */
    public interface OnItemChildLongClickListener {
         ...
         * click and held
         *
         * @param view     The childView whihin the itemView that was clicked and
         *                 held.
         * @param position The position of the view int the adapter
         * @return true if the callback consumed the long click ,false otherwise
         */
        @SuppressWarnings("rawtypes")
        boolean onItemChildLongClick(BaseQuickAdapter adapter, View view,
                                     int position);
    }
    ...
    public interface OnItemLongClickListener {
         ...
         * @param view     The view whihin the RecyclerView that was clicked and
         *                 held.
         * @param position The position of the view int the adapter
         * @return true if the callback consumed the long click ,false otherwise
         */
        boolean onItemLongClick(BaseQuickAdapter<?, ?> adapter, View view,
                                int position);
    }
    ...
    public interface OnItemClickListener {
         ...
         *
         * @param adapter  the adpater
         * @param view     The itemView within the RecyclerView that was clicked
    ...
    /**
     * Register a callback to be invoked when an itemchild in View has been
     * clicked
     *
    ...
    /**
     * Register a callback to be invoked when an itemchild in this View has been
     * long clicked and held
     *
     * @param listener The callback that will run
     */
    ...
    /**
     * @return The callback to be invoked with an itemchild in this RecyclerView
    ...
    /**
     * @return The callback to be invoked with an itemChild in this RecyclerView
     * has been long clicked, or null id no callback has been set.
     */
    @Nullable
