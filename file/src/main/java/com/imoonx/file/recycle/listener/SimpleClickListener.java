package com.imoonx.file.recycle.listener;
 ...
 * <p>
 * This can be useful for applications that wish to implement various forms of
 * click and longclick and childView click manipulation of item views within the
 * RecyclerView. SimpleClickListener may intercept a touch interaction already
 * in progress even if the SimpleClickListener is already handling that gesture
...
public abstract class SimpleClickListener implements RecyclerView.OnItemTouchListener {
    ...
    public boolean onInterceptTouchEvent(RecyclerView rv, MotionEvent e) {
        ...
        if (!mGestureDetector.onTouchEvent(e)
                && e.getActionMasked() == MotionEvent.ACTION_UP && mIsShowPress) {
                    ...
                    if (longClickViewIds != null && longClickViewIds.size() > 0) {
                        for (Integer longClickViewId : longClickViewIds) {
                            ...
                            if (inRangeOfView(childView, e) && childView.isEnabled()) {
                                ...
                                setPressViewHotSpot(e, childView);
                                onItemChildLongClick(baseQuickAdapter, childView, vh.getLayoutPosition() - baseQuickAdapter
                                        .getHeaderLayoutCount());
                                childView.setPressed(true);
                                mIsShowPress = true;
                                isChildLongClick = true;
    ...
    private void setPressViewHotSpot(final MotionEvent e,
                                     final View mPressedView) {
    ...
    /**
     * callback method to be invoked when an item in this view has been click
     * and held
     *
