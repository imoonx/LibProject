...
public class BaseViewHolder extends RecyclerView.ViewHolder {
     ...
     * <p>
     * or if you can use recyclerView.addOnItemTouch(listerer) wo also
     * support this menthod
     */
            ...
            view.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (adapter.getOnItemChildClickListener() != null) {
                        adapter.getOnItemChildClickListener().onItemChildClick(
        ...
        if (view != null) {
            ...
            view.setOnLongClickListener(new View.OnLongClickListener() {
                ...
                public boolean onLongClick(View v) {
                    return adapter.getOnItemChildLongClickListener() != null && adapter.getOnItemChildLongClickListener()
     ...
     * @return The BaseViewHolder for chaining. Please use
     * {@link #addOnLongClickListener(int)}
     * (adapter.setOnItemChildLongClickListener(listener))}
     */
    @Deprecated
     ...
     * @return The BaseViewHolder for chaining. Please use
     * {@link #addOnClickListener(int)} (int)}
