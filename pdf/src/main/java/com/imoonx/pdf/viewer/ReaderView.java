...
public class ReaderView extends AdapterView<Adapter> implements GestureDetector.OnGestureListener, ScaleGestureDetector.
        OnScaleGestureListener, Runnable {
    ...
    public boolean onDown(MotionEvent arg0) {
        XLog.e(ReaderView.class, "onDown");
        mScroller.forceFinished(true);
        return true;
    }

    public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX, float velocityY) {
        XLog.e(ReaderView.class, "onFling");
        if (mScaling)
            return true;
        View v = mChildViews.get(mCurrent);
        if (v != null) {
